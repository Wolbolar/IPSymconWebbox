...
<script type="text/javascript" src="../../js/dreambox.js"></script>
...
<div data-role="page" id="page">
  <div data-role="content">
      <div id="reload">aktualisieren</div>
        ...
        <!--
        <p id="socialbookmarksanzeigen1">
            <a href="#" id="sobo-einausblenden1">Ein- Ausblenden</a>
        </p>
        <section id="sozialbookmarks1">
          <p><b>Bereich für social bookmarks</b><br>
          Hier kommen nun die üblichen Verdächtigen und Logos dazu.<br>
          Nicht vergessen, meine Seite zu bookmarken!</p>
        </section>
        -->
        <div id="socialbookmarksanzeigen1">
        <a href="#" id="sobo-einausblenden1">Beschreibung</a>
        </div>
        <section id="sozialbookmarks1">Raum für den Inhalt Weitere Info
