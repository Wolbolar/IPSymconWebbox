...
<section id="oc3buttom">
  <div class="oc3icon" id="tempicon"><img src="images/svg/temperature27.svg" alt="temp" height="75"/></div><div class="oc3buttomtext" id="temp">Temperatur</div><div class="oc3buttomvalue" id="tempvalue"><?php echo utf8_encode($temp); ?></div>
  <div class="oc3icon" id="humidityicon"><img src="images/svg/drop18.svg" alt="humidity" height="75"/></div><div class="oc3buttomtext" id="humidity">Luftfeuchte</div><div class="oc3buttomvalue" id="humidityvalue"><?php echo $humidity; ?></div>
