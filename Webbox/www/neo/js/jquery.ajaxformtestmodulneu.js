...
ajaxrequest('cmd/dreambox/ipsrequestneu.php', 'get', 'command=neostatus?');
...
// Sendet NEO Status		  
 			$("#neostatus").change(function() {
            var neo_statusflip = $("#flipneostatus").val();
            // Sendet Request bei Ändern des Status
			// alert ("Befehl: command=" + dreambox_statusflip + " gesendet");
            ajaxrequest('cmd/dreambox/ipsrequestneu.php', 'get', 'command='+neo_statusflip);
            }); 
						...
						if (neostatus === "true")
							{
								...
								$("aktuellerNEOstatus").html(e2command);
								alert ("Status "+neostatus+" !");
